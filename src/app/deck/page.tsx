  ...
  return (
    <>
      ...
      <main style={{ 
        ...
        {/* Background glow - positioned safely within bounds */}
        <div style={{ 
          position: "fixed", 
          top: 0,
          right: 0,
          ...
          height: "60%",
          background: "radial-gradient(circle at 100% 0%, rgba(255,107,107,0.12) 0%, transparent 60%)",
          pointerEvents: "none",
          zIndex: 0
        }} />
        <div style={{ 
          ...
          height: "50%",
          background: "radial-gradient(circle at 0% 100%, rgba(255,150,100,0.08) 0%, transparent 60%)",
          pointerEvents: "none",
          zIndex: 0
        }} />
