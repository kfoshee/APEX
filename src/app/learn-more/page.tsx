  ...
  return (
    ...
    >
      <div style={{ background: '#0a0a0b', padding: compact ? '8px 12px' : (isMobile ? '8px 12px' : '10px 14px'), display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        <div style={{ flex: 1, background: 'rgba(255,255,255,0.05)', borderRadius: 5, padding: compact ? '4px 10px' : (isMobile ? '4px 8px' : '5px 12px'), marginLeft: 8, minWidth: 0 }}>
      ...
      <div style={{ background: '#0a0a0b', padding: compact ? '8px 14px' : (isMobile ? '8px 12px' : '10px 16px'), display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 6 : 8, minWidth: 0 }}>
          <div style={{ width: compact ? 22 : (isMobile ? 20 : 26), height: compact ? 22 : (isMobile ? 20 : 26), background: 'linear-gradient(135deg, #ff6b6b, #ee5a5a)', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          ...
          <div style={{ width: compact ? 24 : (isMobile ? 22 : 28), height: compact ? 24 : (isMobile ? 22 : 28), background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
  ...
  return (
    <motion.nav initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ background: 'rgba(10,10,10,0.8)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: isMobile ? '12px 16px' : '14px 24px', position: 'sticky', top: 0, zIndex: 100 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <motion.button onClick={handleBackToHome} style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'white', background: 'none', border: 'none', cursor: 'pointer', minWidth: 0 }} whileHover={{ x: -3 }} whileTap={{ scale: 0.98 }}>
          <ArrowLeft style={{ width: 16, height: 16, color: '#52525b', flexShrink: 0 }} />
          <Image src="/APEX-Final-White.svg?v=100" alt="APEX" width={20} height={20} style={{ height: 20, width: 20, flexShrink: 0 }} priority unoptimized />
          <span style={{ fontSize: 13, fontWeight: 500 }}>APEX</span>
        </motion.button>
        <motion.button onClick={() => navigateWithScroll('/apply')} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ background: 'linear-gradient(135deg, #ff6b6b, #ee5a5a)', color: 'white', fontSize: isMobile ? 12 : 13, fontWeight: 600, padding: isMobile ? '8px 16px' : '10px 20px', borderRadius: 100, border: 'none', cursor: 'pointer', boxShadow: '0 4px 20px -5px rgba(255,107,107,0.5)', flexShrink: 0, whiteSpace: 'nowrap' }}>Apply Now</motion.button>
      </div>
    </motion.nav>
  );
}
          ...
          <div style={{ padding: isMobile ? 16 : 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: isMobile ? 10 : 12, marginTop: 20, marginBottom: 24 }}>
              {[
                ...
                <motion.div key={stat.label} initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.4 + i * 0.1 }} style={{ background: 'rgba(255,255,255,0.02)', borderRadius: isMobile ? 12 : 14, padding: isMobile ? 12 : 16, border: '1px solid rgba(255,255,255,0.04)', minWidth: 0 }}>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.7 }} style={{ background: 'linear-gradient(135deg, rgba(255,107,107,0.1) 0%, rgba(255,107,107,0.02) 100%)', border: '1px solid rgba(255,107,107,0.15)', borderRadius: 16, padding: isMobile ? 16 : 20 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
                ...
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ display: 'flex', alignItems: 'center', gap: 8, background: '#ff6b6b', color: 'white', fontSize: isMobile ? 13 : 14, fontWeight: 600, padding: isMobile ? '10px 20px' : '12px 24px', borderRadius: 100, border: 'none', cursor: 'pointer', flexShrink: 0, whiteSpace: 'nowrap' }}>
  ...
  return (
    <section ref={ref} style={{ background: '#fafafa', padding: isMobile ? '60px 20px' : '100px 24px' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <AppChrome>
          <div style={{ position: 'relative', aspectRatio: '16/9', background: 'linear-gradient(135deg, #1a1a2e 0%, #0f0f1a 100%)', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: isMobile ? 16 : 0 }}>
              ...
              <div style={{ overflowX: 'auto', maxWidth: '100%' }}>
                <code style={{ background: 'rgba(255,255,255,0.05)', padding: isMobile ? '10px 16px' : '14px 28px', borderRadius: isMobile ? 10 : 14, color: '#10b981', fontSize: isMobile ? 12 : 20, fontFamily: 'monospace', whiteSpace: 'nowrap', display: 'block' }}>Retention = ((End - New) / Start) x 100</code>
              </div>
            </div>
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: isMobile ? '16px 12px 12px' : '24px 20px 16px', background: 'linear-gradient(transparent, rgba(0,0,0,0.9))' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 10 : 14 }}>
                <Pause style={{ width: isMobile ? 16 : 18, height: isMobile ? 16 : 18, color: 'white', flexShrink: 0 }} />
                ...
                <span style={{ color: 'white', fontSize: isMobile ? 11 : 13, flexShrink: 0, whiteSpace: 'nowrap' }}>5:42 / 12:30</span>
              </div>
            </div>
          </div>
        </AppChrome>
      ...
      <div style={{ maxWidth: 500, margin: '0 auto' }}>
        ...
        <AppChrome compact>
          <div style={{ padding: isMobile ? '12px 14px' : '14px 18px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: isMobile ? 36 : 42, height: isMobile ? 36 : 42, background: 'linear-gradient(135deg, #10b981, #059669)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          <div style={{ padding: isMobile ? '12px 14px' : '14px 18px', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', gap: isMobile ? 10 : 12 }}>
            <div style={{ flex: 1, background: 'rgba(255,255,255,0.03)', borderRadius: 14, padding: isMobile ? '12px 14px' : '14px 18px', fontSize: isMobile ? 13 : 14, color: '#52525b', minWidth: 0 }}>Ask anything...</div>
            <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }} style={{ background: 'linear-gradient(135deg, #10b981, #059669)', border: 'none', borderRadius: 14, width: isMobile ? 44 : 48, height: isMobile ? 44 : 48, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
        ...
        <AppChrome>
          <div style={{ padding: isMobile ? '12px 14px' : '14px 18px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <motion.div animate={isInView ? { scale: [1, 1.3, 1] } : {}} transition={{ duration: 1.5, repeat: Infinity }} style={{ width: 10, height: 10, background: '#10b981', borderRadius: '50%', flexShrink: 0 }} />
              <span style={{ color: 'white', fontSize: isMobile ? 14 : 15, fontWeight: 600 }}>Study Call</span>
            </div>
            <span style={{ color: '#71717a', fontSize: isMobile ? 13 : 14, flexShrink: 0 }}>47:23</span>
          </div>

          <div style={{ padding: isMobile ? 12 : 18, display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: isMobile ? 10 : 14 }}>
            {peers.map((p, i) => (
              <motion.div key={p.name} initial={{ opacity: 0, scale: 0.9 }} animate={isInView ? { opacity: 1, scale: 1 } : {}} transition={{ delay: 0.3 + i * 0.1 }} style={{ aspectRatio: '4/3', background: `${p.color}10`, borderRadius: isMobile ? 14 : 18, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: p.speaking ? `3px solid ${p.color}` : '3px solid transparent', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ padding: isMobile ? '12px 14px' : '14px 18px', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'center', gap: isMobile ? 10 : 14 }}>
            {[Mic, VideoIcon, Monitor, Hand].map((Icon, i) => (
              <motion.button key={i} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} style={{ width: isMobile ? 40 : 44, height: isMobile ? 40 : 44, background: i < 2 ? 'rgba(255,255,255,0.08)' : 'rgba(255,255,255,0.03)', borderRadius: '50%', border: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
        ...
        <AppChrome>
          <div style={{ background: '#0a0a0a', padding: isMobile ? '14px 16px' : '18px 22px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <motion.div initial={{ rotate: 0 }} animate={isInView ? { rotate: [0, -5, 5, 0] } : {}} transition={{ delay: 0.5, duration: 0.5 }} style={{ width: isMobile ? 40 : 48, height: isMobile ? 40 : 48, background: 'linear-gradient(135deg, #10b981, #059669)', borderRadius: isMobile ? 10 : 12, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: isMobile ? 16 : 20, fontWeight: 700, flexShrink: 0 }}>R</motion.div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', minWidth: 0 }}>
                <span style={{ color: 'white', fontSize: isMobile ? 15 : 17, fontWeight: 600 }}>Rushly</span>
                <span style={{ background: 'rgba(255,107,107,0.15)', color: '#ff6b6b', fontSize: isMobile ? 9 : 10, fontWeight: 700, padding: '3px 8px', borderRadius: 4, flexShrink: 0 }}>LIVE</span>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: isMobile ? 16 : 22 }}>
            ...
            <div style={{ display: 'flex', gap: isMobile ? 16 : 24, marginBottom: isMobile ? 20 : 24, flexWrap: 'wrap' }}>
              {[
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 10 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.3 + i * 0.1 }} style={{ textAlign: 'center', flex: isMobile ? '1 1 80px' : 'none', minWidth: 0 }}>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto" }}>
        ...
        <AppChrome>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr" }}>
            <div style={{ padding: isMobile ? 16 : 20, borderRight: isMobile ? "none" : "1px solid rgba(255,255,255,0.05)", borderBottom: isMobile ? "1px solid rgba(255,255,255,0.05)" : "none", minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: isMobile ? 12 : 16 }}>
                <Terminal style={{ width: 16, height: 16, color: "#f59e0b", flexShrink: 0 }} />
                <span style={{ color: "#71717a", fontSize: isMobile ? 11 : 12, fontWeight: 600 }}>QUERY</span>
              </div>
              <pre style={{ fontFamily: "monospace", fontSize: isMobile ? 12 : 14, color: "#10b981", lineHeight: 1.6, margin: 0, whiteSpace: "pre-wrap", wordBreak: "break-all", overflowWrap: "break-word" }}>
                {typed}
                <motion.span animate={{ opacity: [1, 0, 1] }} transition={{ duration: 0.8, repeat: Infinity }} style={{ color: "#ff6b6b" }}>|</motion.span>
              </pre>
            </div>

            <div style={{ padding: isMobile ? 16 : 20, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: isMobile ? 12 : 16 }}>
                <Table style={{ width: 16, height: 16, color: "#3b82f6", flexShrink: 0 }} />
          ...
          <div style={{ padding: isMobile ? 14 : 18 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: isMobile ? 14 : 18 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, minWidth: 0 }}>
                <RefreshCw style={{ width: isMobile ? 18 : 20, height: isMobile ? 18 : 20, color: '#ec4899', flexShrink: 0 }} />
                <span style={{ color: 'white', fontSize: isMobile ? 14 : 15, fontWeight: 600 }}>Daily Review</span>
              </div>
              <span style={{ color: '#10b981', fontSize: isMobile ? 12 : 13, fontWeight: 600, flexShrink: 0 }}>5 min</span>
            </div>
            {['SQL JOINs', 'Retention formulas', 'A/B test basics'].map((t, i) => (
              <motion.div key={t} initial={{ opacity: 0, x: -20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.3 + i * 0.12 }} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'rgba(255,255,255,0.03)', borderRadius: 12, padding: isMobile ? '12px 14px' : '14px 16px', marginBottom: 10, gap: 12 }}>
                <span style={{ color: 'white', fontSize: isMobile ? 13 : 14, minWidth: 0 }}>{t}</span>
                <span style={{ color: i === 0 ? '#f59e0b' : '#52525b', fontSize: isMobile ? 11 : 12, fontWeight: 500, flexShrink: 0, whiteSpace: 'nowrap' }}>{i === 0 ? 'Due now' : i === 1 ? 'Tomorrow' : '3 days'}</span>
              </motion.div>
            ))}
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2 }} style={{ background: 'white', borderRadius: isMobile ? 24 : 28, overflow: 'hidden', boxShadow: '0 25px 60px -15px rgba(0,0,0,0.15)' }}>
          ...
          <div style={{ padding: isMobile ? 20 : 24 }}>
            ...
            {[
              ...
              <motion.div key={w.title} initial={{ opacity: 0, x: -20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.6 + i * 0.1 }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#fafafa', borderRadius: 12, padding: isMobile ? '12px 14px' : '14px 16px', marginBottom: 10, gap: 12 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
                  <FileText style={{ width: isMobile ? 16 : 18, height: isMobile ? 16 : 18, color: '#10b981', flexShrink: 0 }} />
                  <span style={{ fontSize: isMobile ? 13 : 14, fontWeight: 600, color: '#0a0a0a' }}>{w.title}</span>
                </div>
                <span style={{ background: 'rgba(255,107,107,0.1)', color: '#ff6b6b', fontSize: isMobile ? 10 : 11, fontWeight: 700, padding: '5px 10px', borderRadius: 100, flexShrink: 0, whiteSpace: 'nowrap' }}>{w.badge}</span>
              </motion.div>
            ))}
          </div>
        </motion.div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, alignItems: isMobile ? 'center' : 'flex-start' }}>
              {[
                ...
                <motion.div key={item.text} initial={{ opacity: 0, x: -20 }} animate={isInView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.2 + i * 0.1 }} style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  <div style={{ width: isMobile ? 44 : 48, height: isMobile ? 44 : 48, background: 'rgba(6,182,212,0.1)', borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <div style={{ padding: isMobile ? '8px 18px 20px' : '10px 22px 24px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: isMobile ? 20 : 24 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 10 }}>
                      <div style={{ width: isMobile ? 28 : 32, height: isMobile ? 28 : 32, background: '#ff6b6b', borderRadius: isMobile ? 7 : 9, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
